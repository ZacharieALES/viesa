...
public class EditMaximalSimilarity extends AbstractTutoStep {
	...
	public String description() {
		return "You may be wondering what is the difference between standard annotations and numerical annotations.<br>"
				...
				+ "- In numerical columns, the similarity depends on the value of one parameter 'M' called <i>maximal similarity</i>.<br><br>"
				+ "More precisely, the similarity sim(x, y) between two numerical annotations <i>x</i> and <i>y</i> is equal to M - |x - y| (or 0 if this value is negative).<br><br>"
				+ "As a consequence: <br>"
