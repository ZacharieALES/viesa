...
//	private AAList corpusList = new AAList();
	...
	private JIconButton jb_switchOrientationAB = new JIconButton("img/horizontal2.png");
		...
		jb_switchOrientationAB.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(isVerticalAB){
					...
					changeTableOrientationAB(!isVerticalAB);
				}
				else{
...
//		double gap = (double)size / nbOfLabel;
	...
	private void changeTableOrientationAB(boolean becomeHorizontal){
		
		aaTablePanelAB.removeAll();
		...
		if(becomeHorizontal){
			...
			aaTablePanelAB.add(jp_lA, "growx");
			aaTablePanelAB.add(jp_lB, "growx, wrap");
			aaTablePanelAB.add(tableA.getJSP(), "grow");
			aaTablePanelAB.add(tableB.getJSP() ,"grow");
		}
